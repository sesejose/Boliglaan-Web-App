      ...
      <nav className="nav">
        <div className="nav-container">
          ...
          <div id="menu-desk">
            <ul>
              ...
              <li>
                <Link href={"/kurser"} onClick={closeMenu}>
                  <p>Kurser</p>
                </Link>
              </li>
              <li>
            ...
            <Link href={""} className="basket-icon" onClick={openBasket}>
              ...
              <div className="flex-column">
                <div className="how-many">
                  {/* The following will be the amount of courses added to the basket - Pick state from MyApp.js */}
        ...
        <div id="menu">
          <ul>
            ...
            <li>
              <Link className="" href={"/kurser"} onClick={closeMenu}>
                <p>Kurser</p>
              </Link>
            </li>
            <li>
